...
<template>
  <div class="min-h-screen flex justify-center items-center bg-[#A3ACBD]">
    <div class="flex flex-col px-4 py-4 bg-[#1f2a3d] rounded-lg z-10">
      <h2 class="m-auto text-2xl my-6 text-[#06ddc4]">FORGOTTEN PASSWORD</h2>
      ...
      <button @click="authStore.resetPassword(auth)" class="bg-[#007B6D] w-3/4 m-auto rounded-lg text-white py-2 mt-4 hover:bg-[#005E53]">Log in</button>
